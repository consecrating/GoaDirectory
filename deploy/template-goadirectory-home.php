<?php
/**
 * Template Name: Goa Directory Home (Redesign)
 * Standalone front-page template. Outputs a self-contained page (its own header/footer),
 * so it does not depend on ClassiPress headers. Assign a Page to this template and set it
 * as the static front page (Settings > Reading). Fully reversible.
 */
