...
<header class="hd"><div class="wrap">
  ...
  <nav class="main" aria-label="Primary"><a href="https://www.goadirectory.in/" class="active">Home</a><a href="https://www.goadirectory.in/ads/">Businesses</a><a href="https://www.goadirectory.in/categories/">Categories</a><a href="https://www.goadirectory.in/blog/">Blog</a><a href="https://www.goadirectory.in/plans/">Plans</a><a href="https://www.goadirectory.in/contact-us/">Contact</a><a class="nav-wa" href="https://wa.me/919923352923" target="_blank" rel="noopener"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2a10 10 0 0 0-8.6 15L2 22l5.1-1.3A10 10 0 1 0 12 2zm0 2a8 8 0 0 1 0 16 8 8 0 0 1-4.1-1.1l-.3-.2-3 .8.8-2.9-.2-.3A8 8 0 0 1 12 4zm4.4 11c-.2.6-1.2 1.1-1.7 1.1-.4 0-1 .1-3-1s-3.1-3-3.3-3.2c-.2-.2-1-1.3-1-2.5s.6-1.7.8-2c.2-.2.4-.3.6-.3h.4c.1 0 .3 0 .5.4l.7 1.7c0 .2.1.3 0 .5l-.3.5-.3.3c-.2.2 0 .4.1.6.3.4.8 1 1.3 1.5.7.6 1.2.8 1.5 1 .2 0 .3 0 .5-.2l.7-.8c.2-.2.3-.2.6-.1l1.6.8c.2.1.4.2.4.3.1.1.1.6-.1 1.1z"/></svg> WhatsApp</a></nav>
...
add_action('template_redirect', function () {
    ...
    echo '<nav class="tabs" aria-label="Sections"><a class="active" href="#about">Overview</a>' . ($gal ? '<a href="#gallery">Photos</a>' : '') . '<a href="#location">Location</a><a href="#contact">Contact</a><a class="nav-wa" href="https://wa.me/919923352923" target="_blank" rel="noopener"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2a10 10 0 0 0-8.6 15L2 22l5.1-1.3A10 10 0 1 0 12 2zm0 2a8 8 0 0 1 0 16 8 8 0 0 1-4.1-1.1l-.3-.2-3 .8.8-2.9-.2-.3A8 8 0 0 1 12 4zm4.4 11c-.2.6-1.2 1.1-1.7 1.1-.4 0-1 .1-3-1s-3.1-3-3.3-3.2c-.2-.2-1-1.3-1-2.5s.6-1.7.8-2c.2-.2.4-.3.6-.3h.4c.1 0 .3 0 .5.4l.7 1.7c0 .2.1.3 0 .5l-.3.5-.3.3c-.2.2 0 .4.1.6.3.4.8 1 1.3 1.5.7.6 1.2.8 1.5 1 .2 0 .3 0 .5-.2l.7-.8c.2-.2.3-.2.6-.1l1.6.8c.2.1.4.2.4.3.1.1.1.6-.1 1.1z"/></svg> WhatsApp</a></nav>';
