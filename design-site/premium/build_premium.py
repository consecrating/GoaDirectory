...
.card .ft{gap:.6rem}
.card .ft .cta{color:var(--brand);font-weight:700;font-family:var(--f-head);display:inline-flex;align-items:center;gap:.35rem;font-size:.92rem;white-space:nowrap}
.card .ft .row{white-space:nowrap;font-size:.82rem}
